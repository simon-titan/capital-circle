      ...
      <Stack gap={6} maxW="720px" mx="auto">
        <GlassCard highlight>
          ...
          <Text className="inter" color="var(--color-text-muted)" fontSize="sm" mb={6}>
            Der Positionsrechner ist Teil des kostenpflichtigen Angebots.
          </Text>
          <ChakraLinkButton href="/dashboard" variant="outline" borderColor="rgba(212,175,55,0.45)" color="var(--color-accent-gold)">
            Zum Dashboard
          </ChakraLinkButton>
        </GlassCard>
      </Stack>
